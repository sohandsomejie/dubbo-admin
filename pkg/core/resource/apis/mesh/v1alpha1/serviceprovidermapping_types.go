...
func (r *ServiceProviderMappingResource) ResourceMesh() string {
	return r.Mesh
}
...
func (r *ServiceProviderMappingResource) String() string {
	...
	if err != nil {
		logger.Errorf("failed to encode ServiceProviderMappingResource: %s to json, err: %v", r.ResourceKey(), err)
		return ""
	}
...
func NewServiceProviderMappingResourceWithAttributes(name string, mesh string) *ServiceProviderMappingResource {
	return &ServiceProviderMappingResource{
		...
		Mesh: mesh,
		Spec: &meshproto.ServiceProviderMapping{},
	}
}
...
func (r *ServiceProviderMappingResourceList) DeepCopyObject() k8sruntime.Object {
	out := &ServiceProviderMappingResourceList{
		TypeMeta: r.TypeMeta,
	}
